...
//            new Choice(SinkingBoatsChoice::new, "Boats you ride sink", false, "SINKING_BOATS"),
//            new Choice(NoSprintChoice::new, "You cannot sprint", false, "NO_SPRINT"),
            new Choice(BlocksFightBackChoice::new, "Blocks you break fight back", false, "BLOCKS_FIGHT_BACK"),
    };
}
